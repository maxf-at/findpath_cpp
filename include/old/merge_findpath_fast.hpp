...
class findpath
{
   private:
    ...
    s_graph   findpath_sections(int_loops current_sections, short* pt_1, short* pt_2);
...
auto findpath::init() -> s_graph
{
    ...
    // process_ext_loops(ext_loops, pt_1, pt_2);
...
void findpath::process_ext_loops(ext_loops ext_loops, short* pt_1, short* pt_2)
{
    ...
    bool Verbose                       = true;
    int  merge_search_width_multiplier = 2;

    fmt::print("ext loops count {}\n", ext_loops.size());
    ...
    for (int i = 0; i < ext_loops.size(); i++) {
        ...
        int current_bp_dist = current_ext_loop.bp_dist;
        ...
        // s_graph current_G = findpath_sections(current_ext_loop, current_pt_1, current_pt_2);
        ...
        fmt::print("start merging last \n");
        fmt::print("{}\n", vrna_db_from_ptable(last_pt_1));
        fmt::print("{}\n", vrna_db_from_ptable(last_pt_2));
        fmt::print("start merging current \n");
        fmt::print("{}\n", vrna_db_from_ptable(current_pt_1));
        fmt::print("{}\n", vrna_db_from_ptable(current_pt_2));
        fmt::print("start merging last \n");
        fmt::print("{}\n", vrna_db_from_ptable(last_G.pt_1));
        fmt::print("{}\n", vrna_db_from_ptable(last_G.pt_2));
        fmt::print("start merging current \n");
        fmt::print("{}\n", vrna_db_from_ptable(current_G.pt_1));
        fmt::print("{}\n", vrna_db_from_ptable(current_G.pt_2));
        fmt::print("into: \n");
        fmt::print("{}\n", vrna_db_from_ptable(merged_pt_1));
        fmt::print("{}\n", vrna_db_from_ptable(merged_pt_2));
        fmt::print("bp: {} {} {} \n", last_G.bp_dist, current_G.bp_dist, merge_bp_dist);
        ...
        auto all_paths = merge_method(current_G, last_G, merged_pt_1, s1_en, merged_pt_2, s2_en,
...
s_graph findpath::findpath_sections(int_loops current_sections, short* pt_1, short* pt_2)
{
    bool Verbose = false;
    // bool Verbose = true;
