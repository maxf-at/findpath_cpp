    ...
    if (direction) {
        ...
        for (const auto& current_edge : input_node.in_edges) {
            ...
            if (current_en <= max_en) {
                ...
                std::string s = vrna_db_from_ptable(new_path.current_ptable);
                // if (G1_G2 == 1)
                // fmt::print("{} BW G1 {}->{} / {} {} {}\n", s, current_path.current_G1_node, current_edge.destination, i, j, current_en);
                // else
                // fmt::print("{} BW G2 {}->{} / {} {} {}\n", s, current_path.current_G2_node, current_edge.destination, i, j, current_en);
