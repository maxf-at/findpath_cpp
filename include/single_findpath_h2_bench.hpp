...
double time_1_init                 = 0;
double time_2_candidates           = 0;
double time_2_candidate_conversion = 0;
double time_2_candidate_en_eval    = 0;
double time_3_sort_unique          = 0;
double time_4_sort_energy          = 0;
double time_5_memcpy               = 0;
double time_6_final_cleanup        = 0;
double memory_a                    = 0;
double memory_b                    = 0;
    ...
    -> std::vector<sorted_path>
{
    ...
    time_1_init                 = 0;
    time_2_candidates           = 0;
    time_2_candidate_conversion = 0;
    time_2_candidate_en_eval    = 0;
    time_3_sort_unique          = 0;
    time_4_sort_energy          = 0;
    time_5_memcpy               = 0;
    time_6_final_cleanup        = 0;
    memory_a                    = 0;
    memory_b                    = 0;
    ...
    py::print("A", time_1_init/1000000);
    py::print("B", time_2_candidates/1000000);
    py::print("C", time_2_candidate_conversion/1000000);
    py::print("D", time_2_candidate_en_eval/1000000);
    py::print("E", time_3_sort_unique/1000000);
    py::print("F", time_4_sort_energy/1000000);
    py::print("G", time_5_memcpy/1000000);
    py::print("H", time_6_final_cleanup/1000000);
    ...
    -> std::vector<sorted_path>
{
    ...
    for (d = 1; d <= bp_dist; d++) {
        ...
        for (c = 0; current[c].s != nullptr; c++) {
            ...
            auto end     = std::chrono::system_clock::now();
            auto elapsed = end - start;
            time_2_candidate_conversion += elapsed.count();
            ...
            for (int a = 0; a < move_list.size(); a++) {
                ...
                auto end     = std::chrono::system_clock::now();
                auto elapsed = end - start;
                time_2_candidate_en_eval += elapsed.count();
            ...
            elapsed = end - start;
            time_2_candidates += elapsed.count();
        }
        ...
        auto end     = std::chrono::system_clock::now();
        auto elapsed = end - start;
        time_3_sort_unique += elapsed.count();
        start = std::chrono::system_clock::now();
        ...
        elapsed = end - start;
        time_4_sort_energy += elapsed.count();
        start = std::chrono::system_clock::now();
    ...
    elapsed = end - start;
    time_6_final_cleanup += elapsed.count();
